...
//Moment is a time/ date formatter
...
class Lyrics extends Component {
  ...
  componentDidMount() {
    //we need to make a request for the lyrics and track data
    //this is the way the api is
    axios
      .get(
      ...
      .then(res => {
        ...
        //make another request to get track data like the artist name and others stuffs
      ...
      return (
        <React.Fragment>
          ...
          <ul className="list-group mt-3">
            ...
            <li className="list-group-item">
              <strong>Emplicit Words</strong>{" "}
              {track.explit === 1 ? "Yes" : "No"}
            </li>
            <li className="list-group-item">
